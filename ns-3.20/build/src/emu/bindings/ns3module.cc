...
static struct PyModuleDef emu_FatalImpl_moduledef = {
    PyModuleDef_HEAD_INIT,
    "emu.FatalImpl",
    NULL,
    -1,
    emu_FatalImpl_functions,
};
#endif
...
initemu_FatalImpl(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&emu_FatalImpl_moduledef);
    #else
...
static PyMethodDef emu_Hash_Function_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef emu_Hash_Function_moduledef = {
    PyModuleDef_HEAD_INIT,
    "emu.Hash.Function",
    NULL,
    -1,
    emu_Hash_Function_functions,
};
#endif

static PyObject *
initemu_Hash_Function(void)
{
    PyObject *m;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&emu_Hash_Function_moduledef);
    #else
    m = Py_InitModule3((char *) "emu.Hash.Function", emu_Hash_Function_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
...
static PyMethodDef emu_Hash_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef emu_Hash_moduledef = {
    PyModuleDef_HEAD_INIT,
    "emu.Hash",
    NULL,
    -1,
...
initemu_Hash(void)
{
    ...
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&emu_Hash_moduledef);
    #else
    m = Py_InitModule3((char *) "emu.Hash", emu_Hash_functions, NULL);
    #endif
    if (m == NULL) {
        return NULL;
    }
    ...
    submodule = initemu_Hash_Function();
    if (submodule == NULL) {
        return NULL;
    }
    Py_INCREF(submodule);
...
_wrap_PyNs3EmuHelper__tp_init__0(PyNs3EmuHelper *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    if (Py_TYPE(self) != &PyNs3EmuHelper_Type)
    {
...
#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef emu_moduledef = {
    PyModuleDef_HEAD_INIT,
    "emu",
    NULL,
    -1,
...
MOD_INIT(emu)
{
    ...
    PyObject *submodule;
    #if PY_VERSION_HEX >= 0x03000000
    m = PyModule_Create(&emu_moduledef);
    #else
