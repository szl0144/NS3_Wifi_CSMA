...
MOD_INIT(propagation)
{
    ...
    PyNs3JakesPropagationLossModelMeta_Type.tp_base = Py_TYPE(&PyNs3PropagationLossModel_Type);
    /* Some fields need to be manually inheritted from the parent metaclass */
    PyNs3JakesPropagationLossModelMeta_Type.tp_traverse = Py_TYPE(&PyNs3PropagationLossModel_Type)->tp_traverse;
    PyNs3JakesPropagationLossModelMeta_Type.tp_clear = Py_TYPE(&PyNs3PropagationLossModel_Type)->tp_clear;
    PyNs3JakesPropagationLossModelMeta_Type.tp_is_gc = Py_TYPE(&PyNs3PropagationLossModel_Type)->tp_is_gc;
    ...
    Py_TYPE(&PyNs3JakesPropagationLossModel_Type) = &PyNs3JakesPropagationLossModelMeta_Type;
    ...
    PyModule_AddIntConstant(m, (char *) "OpenAreasEnvironment", ns3::OpenAreasEnvironment);
    {
        ...
        tmp_value = PyLong_FromLong(ns3::Cost231PropagationLossModel::SubUrban);
        ...
        tmp_value = PyLong_FromLong(ns3::Cost231PropagationLossModel::MediumCity);
        ...
        tmp_value = PyLong_FromLong(ns3::Cost231PropagationLossModel::Metropolitan);
