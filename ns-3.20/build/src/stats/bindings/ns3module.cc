...
PyObject *
_wrap_PyNs3FileHelper_AddProbe(PyNs3FileHelper *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    const char *typeId;
    ...
    std::string probeName_std;
    const char *path;
    Py_ssize_t path_len;
    std::string path_std;
    const char *keywords[] = {"typeId", "probeName", "path", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "s#s#s#", (char **) keywords, &typeId, &typeId_len, &probeName, &probeName_len, &path, &path_len)) {
        return NULL;
    }
    typeId_std = std::string(typeId, typeId_len);
    probeName_std = std::string(probeName, probeName_len);
    path_std = std::string(path, path_len);
    self->obj->AddProbe(typeId_std, probeName_std, path_std);
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyMethodDef PyNs3FileHelper_methods[] = {
    ...
    {(char *) "AddProbe", (PyCFunction) _wrap_PyNs3FileHelper_AddProbe, METH_KEYWORDS|METH_VARARGS, NULL },
...
PyObject *
_wrap_PyNs3GnuplotHelper_AddProbe(PyNs3GnuplotHelper *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    const char *typeId;
    Py_ssize_t typeId_len;
...
static PyMethodDef PyNs3GnuplotHelper_methods[] = {
    ...
    {(char *) "AddProbe", (PyCFunction) _wrap_PyNs3GnuplotHelper_AddProbe, METH_KEYWORDS|METH_VARARGS, NULL },
