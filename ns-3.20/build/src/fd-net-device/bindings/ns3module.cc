...
static PyMethodDef PyNs3EmuFdNetDeviceHelper_methods[] = {
    {(char *) "GetDeviceName", (PyCFunction) _wrap_PyNs3EmuFdNetDeviceHelper_GetDeviceName, METH_NOARGS, NULL },
    {(char *) "SetDeviceName", (PyCFunction) _wrap_PyNs3EmuFdNetDeviceHelper_SetDeviceName, METH_KEYWORDS|METH_VARARGS, NULL },
...
static PyMethodDef PyNs3TapFdNetDeviceHelper_methods[] = {
    {(char *) "SetTapIpv4Address", (PyCFunction) _wrap_PyNs3TapFdNetDeviceHelper_SetTapIpv4Address, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetTapIpv4Mask", (PyCFunction) _wrap_PyNs3TapFdNetDeviceHelper_SetTapIpv4Mask, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetTapMacAddress", (PyCFunction) _wrap_PyNs3TapFdNetDeviceHelper_SetTapMacAddress, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetModePi", (PyCFunction) _wrap_PyNs3TapFdNetDeviceHelper_SetModePi, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetTapIpv6Address", (PyCFunction) _wrap_PyNs3TapFdNetDeviceHelper_SetTapIpv6Address, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetTapIpv6Prefix", (PyCFunction) _wrap_PyNs3TapFdNetDeviceHelper_SetTapIpv6Prefix, METH_KEYWORDS|METH_VARARGS, NULL },
